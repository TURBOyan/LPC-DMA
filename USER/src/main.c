...
//		gpio_set(Beep,0);
		OLED_P6x8Int(0, 0,Fourier_Once(ADC_CH6_B0    ,ADC_10BIT), 5);
		OLED_P6x8Int(0, 1,Fourier_Once(ADC_CH0_A10   ,ADC_10BIT), 5);
		OLED_P6x8Int(0, 2,Fourier_Once(ADC_CH3_A15   ,ADC_10BIT), 5);
